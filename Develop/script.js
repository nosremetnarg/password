...
function generatePassword() {
  var confirmLength = window.prompt("How many characters would you like your password to contain? Please pick a number between 8 & 128.");
...
function writePassword() {
  ...
  alert("Your new super cool password is " + password);
  passwordText.value = password;
} 


// a second way to write a random pw gen is below
